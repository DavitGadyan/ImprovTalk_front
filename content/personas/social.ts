...
export const social: Persona = {
  ...
  realtalk: {
    ...
    intro: 'The conversation you had, graded on what you said and how it landed. And before the next one, two or three openers for exactly where you are standing.',
  },
  inside: {
