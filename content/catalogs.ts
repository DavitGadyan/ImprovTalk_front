...
export const catalogs: Catalog[] = [
  { label: 'BE MORE CONFIDENT', name: 'Charisma training', count: 26, hue: 'var(--color-warn)' },
  ...
  { label: 'TALK ABOUT MOVIES', name: 'Famous movies', count: 380, hue: 'var(--color-gold)' },
  { label: 'FAMOUS SONGS', name: 'Songs', count: 263 },
  { label: 'WHAT TATTOOS MEAN', name: 'Tattoos', count: 372, hue: 'var(--color-danger)' },
  ...
  { label: '"WHAT DO YOU DO?"', name: 'Professions & jokes', count: 56, hue: 'var(--color-warn)' },
  ...
  { label: 'READ PEOPLE', name: 'The art of deduction', count: 24, hue: 'var(--color-success)' },
